...
public class SellerFormController implements Initializable {
	...
	public void onBtSaveAction(ActionEvent event) {
		...
		if (service == null) {
			throw new IllegalStateException("Service está nula");
		}
	...
	private Seller getFormData() {
		...
		} else if (txtbirthdate.getText() == null || txtbirthdate.getText().trim().equals("")) {
			exception.addError("birthdata", "O campo não pode ser vazio");

		} else if (txtBasesalary.getText() == null || txtBasesalary.getText().trim().equals("")) {
